...
@section('content')
    <div class="top-banner"
        ...
        <div class="head text-center">
            ...
            <h1>Airport Limo service - DOUGLAS POINT</h1>
        </div>
    </div>
    ...
    <div class="ajax-contant">
        <div class="image-contant">
            ...
            <p><strong>Airport limousine service from / to Douglas Point</strong> - Airfleet limousine specializes in
                providing Douglas Point
                ...
                Limousine
                provides reliable and economical flat-rate airport limousine and taxi transportation to / from Douglas
                Point and
                surrounding areas.
            </p>
            ...
            <p>Why not avoid the hassle of traffic delays to and from the airport, parking difficulties, and expensive,
                ...
                professionals. We are committed to providing you with <strong>highest standard, reliable and
                    timely</strong>
                airport limousine service from/to Douglas Point and surrounding areas.</p>

            <p>Airport limo service is the most reliable, hassle-free option for airport <strong>transportation from
                    Douglas Point.</strong> We will ensure that your ride to the Airport from / to Douglas Point, is
                filled with
    ...
    <div class="map-content">
        ...
        <div class="service">
            ...
            <div class="box">
                ...
                <p>Toronto <span>Pearson Airport limousine</span> service from / to Douglas Point</p>
            </div>

            <div class="box">
                <img src="{{ asset('images/map-mark.png') }}" alt="mark img">
                <p>Toronto Island Airport limousine service from / to Douglas Point</p>
            </div>

            <div class="box">
                <img src="{{ asset('images/map-mark.png') }}" alt="mark img">
                <p>Buffalo Airport Limo Service from / to Douglas Point</p>
            </div>
    ...
    <div class="ajax-banner"
        ...
        <div class="head text-center">
            <p>Our experts are just a call away <span>416-447-5000 / 1-866-991-5548</span>, which makes you one<br>call
                away
                from an incredible experience on your airport limo from / to Douglas Point.<br>
