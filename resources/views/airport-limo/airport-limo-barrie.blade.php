...
@section('content')
    ...
    <div class="top-banner"
        ...
        <div class="head text-center">
            ...
            <h1>Airport Limo service - BARRIE</h1>
        </div>
    </div>
    ...
    <div class="ajax-contant">
        <div class="image-contant">
            ...
            <p><strong>Airport limousine service from / to Barrie</strong> - Airfleet limousine specializes in providing
                Barrie
                ...
                Limousine
                provides reliable and economical flat-rate airport limousine and taxi transportation to / from Barrie
                and
                surrounding areas.
            </p>
            ...
            <p>Why not avoid the hassle of traffic delays to and from the airport, parking difficulties, and expensive,
                ...
                professionals. We are committed to providing you with <strong>highest standard, reliable and
                    timely</strong>
                airport limousine service from/to Barrie and surrounding areas.</p>

            <p>Airport limo service is the most reliable, hassle-free option for airport <strong>transportation from
                    Barrie.</strong> We will ensure that your ride to the Airport from / to Barrie, is filled with
        ...
        <div class="boxes-contant">
            <div class="top-box">
                <h6>Download</h6>
                <a href="{{asset('docs/taxi-limo-outoftown.pdf')}}"><i class="fa-regular fa-file-pdf"></i> Limo / Taxi Tariffs -
    ...
    <div class="map-content">
        ...
        <div class="para">
            <p>Barrie is a city in Southern Ontario, Canada, on the western shore of Lake Simcoe. Although located in
                Simcoe County, the city is politically independent. Barrie is within the northern part of the Greater
                Golden Horseshoe, a densely populated and industrialized region of Ontario. Barrie is served by
                Provincial Highway Highway 400, which acts as the primary route between Barrie and Toronto. Highway 400
                bisects the city on a roughly north-south basis. </p>
        </div>
        ...
        <div class="service">
            ...
            <div class="box">
                ...
                <p>Toronto <span>Pearson Airport limousine</span> service from / to Barrie</p>
            </div>

            <div class="box">
                <img src="{{asset('images/map-mark.png')}}" alt="mark img">
                <p>Toronto Island Airport limousine service from / to Barrie</p>
            </div>

            <div class="box">
                <img src="{{asset('images/map-mark.png')}}" alt="mark img">
                <p>Buffalo Airport Limo Service from / to Barrie</p>
            </div>
    ...
    <div class="ajax-banner"
        ...
        <div class="head text-center">
            <p>Our experts are just a call away <span>416-447-5000 / 1-866-991-5548</span>, which makes you one<br>call
                away
                from an incredible experience on your airport limo from / to Barrie.<br>
