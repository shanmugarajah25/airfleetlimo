...
@section('content')
    <div class="top-banner"
        ...
        <div class="head text-center">
            ...
            <h1>Airport Limo service - GUELPH</h1>
        </div>
    </div>
    ...
    <div class="ajax-contant">
        <div class="image-contant">
            ...
            <p><strong>Airport limousine service from / to Guelph</strong> - Airfleet limousine specializes in providing
                Guelph
                ...
                Limousine
                provides reliable and economical flat-rate airport limousine and taxi transportation to / from Guelph
                and
                surrounding areas.
            </p>
            ...
            <p>Why not avoid the hassle of traffic delays to and from the airport, parking difficulties, and expensive,
                ...
                professionals. We are committed to providing you with <strong>highest standard, reliable and
                    timely</strong>
                airport limousine service from/to Guelph and surrounding areas.</p>

            <p>Airport limo service is the most reliable, hassle-free option for airport <strong>transportation from
                    Guelph.</strong> We will ensure that your ride to the Airport from / to Guelph, is filled with
    ...
    <div class="map-content">
        <div class="head">
            <h6>AIRPORT LIMO FROM GUELPH TO TORONTO PEARSON AIRPORT</h6>
        </div>

        <!--map view-->
        <div class="ajax-map">
            <iframe
                src="https://maps.google.com/maps?f=d&amp;source=s_d&amp;saddr=Guelph,+ON,+Canada&amp;daddr=Toronto+Pearson+International+Airport,+Mississauga,+ON,+Canada&amp;hl=en&amp;geocode=Far5mwId-ARH-ykJtmaeXtDUiTF7gEckzmNu8A%3BFRZ4mgIdjAVB-yHFDgPE6V0dtCmR1C3ASjkriDHFDgPE6V0dtA&amp;aq=&amp;sll=43.409084,-80.167803&amp;sspn=0.58362,1.352692&amp;mra=ls&amp;ie=UTF8&amp;t=m&amp;ll=43.734256,-79.424007&amp;spn=0.105653,0.384581&amp;output=embed"
                height="220" width="100%" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
        </div>
        <!--/map view-->

        <div class="para">
            <p>Guelph is a city in Southwestern Ontario, Canada. Known as &quot;The Royal City&quot;, Guelph is roughly
                28 kilometres (17 mi) east of Waterloo and 100 kilometres (62 mi) west of downtown Toronto at the
                intersection of Highway 6 and Highway 7. </p>
        </div>
        ...
        <div class="service">
            ...
            <div class="box">
                ...
                <p>Toronto <span>Pearson Airport limousine</span> service from / to Guelph</p>
            </div>

            <div class="box">
                <img src="{{ asset('images/map-mark.png') }}" alt="mark img">
                <p>Toronto Island Airport limousine service from / to Guelph</p>
            </div>

            <div class="box">
                <img src="{{ asset('images/map-mark.png') }}" alt="mark img">
                <p>Buffalo Airport Limo Service from / to Guelph</p>
            </div>
    ...
    <div class="ajax-banner"
        ...
        <div class="head text-center">
            <p>Our experts are just a call away <span>416-447-5000 / 1-866-991-5548</span>, which makes you one<br>call
                away
                from an incredible experience on your airport limo from / to Guelph.<br>
