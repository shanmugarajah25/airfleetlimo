            ...
            <div class="home-banner-img"
                ...
                <div class="img-content d-flex">
                    ...
                    <div class="content">
                        ...
                        <div class="para">
                            <p><b>Never miss a flight!</b> Choose one of our <b>85 luxurious vehicles</b> for your ride
                ...
                <div class="col-md-6">
                    <div class="content">
                        ...
                        <form action="#">
                            ...
                            <div class="cal-input">
                                <label for="check"><strong>Pick-up at</strong> <span>Toronto Pearson International
                                        Airport?</span></label>
                                        ...
                                        <div class="card"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <span class="tooltiptext">
                                                    <img class="arrow1"
                                                        src="{{asset('images/arrow-tool.png')}}"
                                                        alt="arrow img">
                                                ...
                                                <a href="{{route('reservation')}}" class="btn btn-danger">Book Now! </a>
                                            </div>
                                        </div>
    ...
    <section class="our-service" id="our-services">
        ...
        <div class="box-content">
            <div class="box">
                ...
                <a href="{{route('services.airport-limo')}}">know more <i class="fa fa-arrow-right" aria-hidden="true"></i>
                </a>
            </div>
            ...
            <div class="box">
                ...
                <p>Airport taxi services rendered by Airfleet Limousine can ensure that you get the best for your
                    transportation</p>
                <a href="{{route('services.airport-taxi')}}">know more <i class="fa fa-arrow-right" aria-hidden="true"></i>
                </a>
            </div>
